program query_kind
       ...
       real    :: dum
       do i=1,35
          print*," per ",i," cifre significative: kind= ",selected_int_kind(i)," per interi e ",selected_real_kind(i)," per reali"
       end do
       print*,"  ***   valori negativi  significano che NON esiste un kind in grado di assicurare la precisione richiesta ***"
       print*
       print*," kind per gli interi di default : ",kind(i)  ! l' argomento e' una qualsiasi variabile intera
